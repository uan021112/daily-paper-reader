...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  <div class="dpr-home-dashboard-header">
    <div>
      <span class="dpr-home-dashboard-kicker">2026-09-05 ~ 2026-09-14</span>
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-14 01:25:35 UTC<br>状态：成功</p>
</section>
...
<p>2026-09-05至09-14共筛出1篇论文，全部速读、无精读，聚焦多视角3D生成中的重建先验注入。最值得看的是《ReconPlusGen》提出的噪声反转与调制思路，用重建先验提升多视角3D生成质量，速读评分6.0。普通读者可先关注该方向能否改善生成一致性，再决定是否深入精读。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="ReconPlusGen: Injecting Reconstruction Prior into Multi-view 3D Generation through Noise Inversion and Modulation">ReconPlusGen: Injecting Reconstruction Prior into Multi-view 3D Generation through Noise Inversion and Modulation</span></li></ul>
  </div>
  <div class="dpr-home-dashboard-tags"><span class="dpr-home-dashboard-tag">surf-recon <strong>1</strong></span></div>
</section>
</div>
